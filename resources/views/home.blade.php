                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three"
                            style="background-image: url(front/assets/images/backgrounds/cloud-1.png);"></div>
                        <!-- /.image-layer -->
                        <div class="main-slider-three__img">
                            <img src="{{ asset('front/assets/images/resources/main-slider-three-img-1.png') }}" alt="" class="float-bob-y">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="main-slider-three__content">
                                        ...
                                        <div class="main-slider-three__btn-box">
                                            @auth
                                            <a href="{{ url('/dashboard') }}" class="thm-btn main-slider__btn">Dashboard</a>
                                            @else
                                            <a href="{{ route('login') }}" class="thm-btn main-slider__btn">Log in</a>
                                            @if (Route::has('register'))
                                            <a href="{{ route('register') }}" class="thm-btn main-slider__btn-two">Register</a>
                                            @endif
                                            @endauth
                                        </div>
                                        @endif
